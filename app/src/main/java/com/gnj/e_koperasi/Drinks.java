...
public class Drinks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispDrinks = findViewById(R.id.dispDrinks);
        dispDrinks.setLayoutManager(new LinearLayoutManager(this));

        itemlist = new ArrayList<>();
        myAdapter = new MainAdapter(this, itemlist, id);
        dispDrinks.setAdapter(myAdapter);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (mainModal != null && "drinks".equals(mainModal.getItem_category())) {
